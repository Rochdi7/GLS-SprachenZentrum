/*
 * CRM student autocomplete widget — wires every .crm-student-ac element on
 * the page to the JSON student-search endpoint.
 *
 * The endpoint URL is injected by Blade as window.CRM_STUDENT_SEARCH_URL
 * (route('backoffice.crm.api.students-search')) BEFORE this script loads.
 */
(function () {
    const ENDPOINT = window.CRM_STUDENT_SEARCH_URL || '';
