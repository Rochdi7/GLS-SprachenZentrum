...
(function () {
  ...
  // Select all .pc-submenu elements inside li elements within .pc-navbar
  var submenus = document.querySelectorAll('.pc-navbar li .pc-submenu');

  // Iterate over each submenu and hide it
  submenus.forEach(function (submenu) {
    submenu.style.display = 'none'; // Hide the submenu by setting display to 'none'
  });
