...
(function () {
  ...
  // Check if .tab-sidemenu exists inside .tab-container, and apply SimpleBar
  const tabSidemenu = document.querySelector('.tab-container > .tab-sidemenu');
  if (tabSidemenu) {
    new SimpleBar(tabSidemenu);
  }

  // Check if .navbar-content exists inside .tab-link within .tab-container, and apply SimpleBar
  const navbarContent = document.querySelector('.tab-container > .tab-link .navbar-content');
  if (navbarContent) {
