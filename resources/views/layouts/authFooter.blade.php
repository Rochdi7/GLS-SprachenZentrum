<div class="auth-sidefooter">
    <img src="{{ URL::asset('build/images/logo-dark.svg') }}" class="img-brand img-fluid" alt="images" />
    <hr class="mb-3 mt-4" />
    <div class="row">
      <div class="col my-1">
        <p class="m-0">Made with ♥ by Team <a href="https://themeforest.net/user/Gls Team" target="_blank"> Gls Team</a></p>
      </div>
