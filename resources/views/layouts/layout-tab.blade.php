...
<body data-pc-direction="ltr" data-pc-preset="preset-5" data-pc-sidebar-theme="light" data-pc-sidebar-caption="true"
    ...
    <script src="{{ URL::asset('build/js/layout-tab.js') }}"></script>
