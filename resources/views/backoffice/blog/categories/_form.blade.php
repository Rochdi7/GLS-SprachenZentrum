<div class="row">
    ...
    <div class="mb-3 col-md-6">
        <label class="form-label fw-bold">Nom catégorie (Français) <span class="text-danger">*</span></label>
    ...
    <!-- NAME EN -->
    <div class="mb-3 col-md-6">
        <label class="form-label fw-bold">Nom Catégorie (Anglais) <span class="text-danger">*</span></label>
