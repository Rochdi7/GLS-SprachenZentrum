                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <span class="text-muted">
                                ...
                                | CRM Class ID : <span
                                    class="badge bg-light-success">{{ $group->crm_class_id ?? 'Non configuré' }}</span>
                            </span>
                        </div>
                        <div>
                            @if ($group->crm_class_id)
                                <a href="{{ route('backoffice.payroll.crm.legacy.import.create', ['group_id' => $group->id]) }}"
                                ...
                                @empty
                                    <tr>
                                        <td colspan="9" class="text-center text-muted py-4">
                                            ...
                                            @if($group->crm_class_id)
                                                <br><a href="{{ route('backoffice.payroll.crm.legacy.import.create', ['group_id' => $group->id]) }}">Créer le premier import CRM</a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforelse
