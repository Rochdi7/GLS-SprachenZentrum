...
.kpi-box:nth-child(1) { background: #1a3a6b; color: #fff; border-color: #1a3a6b; }
.kpi-box:nth-child(2) { background: #f0f4ff; }
.kpi-box:nth-child(3) { background: #f0f4ff; }
.kpi-box:nth-child(4) { background: #f0f4ff; }
.kpi-box + .kpi-box   { border-left: none; }
.kpi-number { font-size: 16px; font-weight: 700; line-height: 1; }
...
table.presence tbody tr:nth-child(even) td.td-name { background: #f7f9ff; }
...
.wk-qual   { background: #d1f5dd; color: #155724; font-weight: 700; }
.wk-unqual { background: #fde8ea; color: #842029; font-weight: 700; }
.wk-amount { font-weight: 700; font-size: 8px; }
...
<div class="page">
    ...
    <div class="meta-grid">
        ...
        <div class="meta-block">
            ...
            <div class="meta-sub">{{ number_format($weeklyUnit, 2) }} DH/semaine · seuil {{ $weekThreshold }}j</div>
        </div>
    </div>
                ...
                <tr>
                    ...
                    @for ($w = 1; $w <= $numWeeks; $w++)
                        ...
                        <td class="{{ $qualified ? 'wk-qual' : 'wk-unqual' }}">
                            <span style="font-size:6.5px; display:block">{{ $presence }}j {{ $qualified ? '✓' : '✗' }}</span>
    ...
    <div class="page-footer">
        ...
        <div class="footer-right">
            www.glszentrum.com · contact@glszentrum.com
        </div>
    </div>
