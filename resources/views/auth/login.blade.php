        ...
        <div class="card my-5">
            <div class="card-body">
                <div class="text-center">
                    <img src="{{ URL::asset('assets/images/login/img-auth-login.png') }}" alt="images" class="img-fluid mb-3">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-group mb-3">
                        <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="admin@Gls Team.com" required autocomplete="email" autofocus id="floatingInput" placeholder="Email Address">
                        @error('email')
