...
<div style="background:#fdf3f3;border-left:4px solid #c1272d;padding:14px 18px;border-radius:6px;margin:18px 0;">
    <div style="font-size:12px;text-transform:uppercase;letter-spacing:1px;color:#922024;font-weight:600;margin-bottom:6px;">Motif</div>
...
<p style="margin:0 0 8px 0;">
    ...
    <a href="mailto:info@glssprachenzentrum.ma" style="color:#1c45db;text-decoration:none;font-weight:600;">info@glssprachenzentrum.ma</a>.
</p>
