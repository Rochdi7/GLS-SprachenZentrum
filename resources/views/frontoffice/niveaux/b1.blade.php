...
<section class="intensive-course-gls section reveal delay-1">
    ...
    <div class="gls-hero-wrapper reveal delay-1">
        ...
        <div class="gls-hero-image reveal delay-1">
            <img src="{{ asset('assets/images/niveaux/hero-b1.avif') }}" 
                 alt="{{ __('niveaux/b1.hero_alt') }}"
    ...
    <div class="gls-path-container reveal delay-2">
        ...
        <div class="gls-path-grid reveal delay-1">
            ...
            <div class="gls-path-card reveal delay-1">
                ...
                <a href="/courses" class="gls-path-button w-button reveal delay-2">{{ __('niveaux/b1.path_1_btn') }}</a>
            </div>
            ...
            <div class="gls-path-card reveal delay-2">
                ...
                <a href="/exams/osd" class="gls-path-button w-button reveal delay-3">{{ __('niveaux/b1.path_2_btn') }}</a>
            </div>
            ...
            <div class="gls-path-card reveal delay-3">
                ...
                <a href="/exams/osd#dates" class="gls-path-button w-button reveal delay-1">{{ __('niveaux/b1.path_3_btn') }}</a>
            </div>
            ...
            <div class="gls-path-card reveal delay-1">
                ...
                <a href="/exams/osd" class="gls-path-button w-button reveal delay-2">{{ __('niveaux/b1.path_4_btn') }}</a>
            </div>
