        ...
        <div class="gls-path-container reveal delay-2">
            ...
            <div class="gls-path-grid reveal delay-1">
                ...
                <div class="gls-path-card reveal delay-1">
                    ...
                    <a href="/courses"
                        class="gls-path-button w-button reveal delay-2">{{ __('niveaux/a2.path_1_btn') }}</a>
                </div>
                ...
                <div class="gls-path-card reveal delay-2">
                    ...
                    <a href="/exams/osd"
                        class="gls-path-button w-button reveal delay-3">{{ __('niveaux/a2.path_2_btn') }}</a>
                </div>
                ...
                <div class="gls-path-card reveal delay-3">
                    ...
                    <a href="/exams/osd#dates"
                        class="gls-path-button w-button reveal delay-1">{{ __('niveaux/a2.path_3_btn') }}</a>
                </div>
                ...
                <div class="gls-path-card reveal delay-1">
                    ...
                    <a href="/exams/osd"
                        class="gls-path-button w-button reveal delay-2">{{ __('niveaux/a2.path_4_btn') }}</a>
                </div>
    ...
    <script>
        ...
        const data = {
            ...
            A2: {
                ...
                priceLink: @json(__('niveaux/a2.data_price_link_text')),
            },
            B1: {
