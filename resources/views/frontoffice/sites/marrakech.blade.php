        ...
        <div class="container is-hero">
            ...
            <div class="hero-image">
                <img src="{{ asset('assets/images/sites/marrakech/centre-marrakech.webp') }}"
                    alt="GLS Sprachenzentrum Marrakech" class="full-image" loading="lazy">
            </div>
        </div>
    </section>
    ...
    <section class="gls-section gls-richtext-wrapper">
        <div class="gls-container">
            <div class="gls-richtext">
                ...
                <p>
                    The <strong>GLS Sprachenzentrum Marrakech</strong> is one of the most active and modern German language
                    hubs
                ...
                <p>
                    Whether you are preparing for studies in Germany, planning for Ausbildung, or aiming to improve your
                    professional
                    prospects, GLS Marrakech provides <strong>structured, immersive, and result-oriented</strong> German
                    courses.
                </p>
                ...
                <p>
                    Our teaching method is built on interaction, communication, and real-life usage — allowing you to
                    progress quickly
    ...
    <section class="home-about-section section">
        <div class="container about-grid">
            ...
            <div class="about-card text-light">
                ...
                <p class="lead mb-4">
                    Welcome to <strong>Deutshow</strong>, Morocco’s first German-language talent competition! 🇩🇪🇲🇦
                    <br><br>
            ...
            <div class="about-video">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/LTPQqtvxzNw?si=83Um2yN1bSR4-YL4"
                    title="Deutshow – Episode 1: Auditions from Marrakech" frameborder="0"
