        ...
        <div class="lp-container">
                        ...
                        <form id="lpForm"
                            ...
                            <div class="lp-section">
                                ...
                                <label class="lp-checkbox" for="lpAcceptTerms">
                                    <input type="checkbox" id="lpAcceptTerms" name="accept_terms" value="1" checked required>
                                    <span>
                ...
                <div class="lp-gallery-scroller">
                    <div class="lp-gallery-grid">
                        @foreach($galleryVideos as $v)
                            <div class="lp-gallery-item" data-reveal style="--reveal-delay:{{ 0.05 + $loop->index * 0.1 }}s">
            ...
            <section class="lp-sites">
                ...
                <div class="lp-sites-grid">
                    <a href="{{ route('front.sites.show', 'gls-rabat') }}" class="lp-site-card small" data-reveal style="--reveal-delay:.05s">
                    ...
                    <a href="{{ route('front.sites.show', 'gls-kenitra') }}" class="lp-site-card small" data-reveal style="--reveal-delay:.12s">
                        <img src="{{ asset('assets/images/sites/kenitra.jpg') }}" alt="GLS Kénitra" class="lp-site-image">
                        <div class="lp-site-overlay">
                            <h3>{{ __('gls.sites.kenitra') }}</h3>
                        </div>
                    </a>

                    <a href="{{ route('front.sites.show', 'gls-marrakech') }}" class="lp-site-card wide" data-reveal style="--reveal-delay:.18s">
                        <img src="{{ asset('assets/images/sites/marrakech.webp') }}" alt="GLS Marrakech" class="lp-site-image">
                        <div class="lp-site-overlay">
                            <h3>{{ __('gls.sites.marrakech') }}</h3>
                        </div>
                    </a>

                    <a href="{{ route('front.sites.show', 'gls-sale') }}" class="lp-site-card wide" data-reveal style="--reveal-delay:.05s">
                    ...
                    <a href="{{ route('front.sites.show', 'gls-agadir') }}" class="lp-site-card small" data-reveal style="--reveal-delay:.12s">
                        <img src="{{ asset('assets/images/sites/agadir.avif') }}" alt="GLS Agadir" class="lp-site-image">
                        <div class="lp-site-overlay">
                            <h3>{{ __('gls.sites.agadir') }}</h3>
                        </div>
                    </a>

                    <a href="{{ route('front.sites.show', 'gls-casablanca') }}" class="lp-site-card small" data-reveal style="--reveal-delay:.18s">
                        <img src="{{ asset('assets/images/sites/casablanca.jpg') }}" alt="GLS Casablanca" class="lp-site-image">
                        <div class="lp-site-overlay">
                    ...
                    <div class="lp-contact-card" data-reveal="left" style="--reveal-delay:.05s">
                        ...
                        <div class="lp-contact-links">
                            <a href="tel:+212669515019" class="lp-contact-link">
                                ...
                                <span class="lp-contact-value">+212 6 03 16 02 77</span>
                            </a>

                            <a href="mailto:info@glssprachenzentrum.ma" class="lp-contact-link">
                                <span class="lp-contact-label">{!! __('home.contact.email_label') !!}</span>
                                <span class="lp-contact-value">info@glssprachenzentrum.ma</span>
                            </a>
                        </div>
                        ...
                        <div class="lp-contact-social">
                            ...
                            <div class="lp-contact-social-row">
                                ...
                                <a href="https://www.facebook.com/gls.sale/" class="lp-social-link fb"
                                    target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                                    <i class="bi bi-facebook"></i>
                                </a>
                                <a href="https://www.youtube.com/@9onsolsTalks" class="lp-social-link yt"
                                    target="_blank" rel="noopener noreferrer" aria-label="YouTube">
                                    <i class="bi bi-youtube"></i>
                                </a>
                                <a href="https://api.whatsapp.com/send/?phone=0669515019&text&type=phone_number&app_absent=0"
                                    class="lp-social-link wa" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
                    ...
                    <script>
                        (function initGlsMap() {
                            ...
                            centres.forEach((c) => {
                                ...
                                const icon = L.divIcon({ html, className: 'gls-pin-icon', iconSize: [120, 56], iconAnchor: [12, 28] });
                                ...
                                li.addEventListener('click', () => { map.flyTo([c.lat, c.lng], 9, { duration: 0.6 }); m.openPopup(); });
