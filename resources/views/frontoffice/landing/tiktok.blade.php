{{-- resources/views/frontoffice/landing/tiktok.blade.php --}}
@extends('frontoffice.layouts.app')

@push('styles')
    <link rel="stylesheet" href="{{ asset('assets/css/lp-tiktok.css') }}">
@endpush
        ...
        <div class="lp-container">
            ...
            <div class="lp-grid">
                ...
                <div class="lp-hero">
                    <div class="lp-source-badge" data-reveal="left">
                        <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                            <path
                                d="M16.6 5.82a4.28 4.28 0 01-1.05-2.82h-3.11v12.4a2.53 2.53 0 01-2.53 2.42 2.53 2.53 0 01-2.53-2.53 2.53 2.53 0 012.53-2.53c.26 0 .51.04.75.11V9.7a5.7 5.7 0 00-.75-.05A5.66 5.66 0 003.6 15.3a5.66 5.66 0 005.66 5.66 5.66 5.66 0 005.66-5.66V9.01a7.34 7.34 0 004.28 1.37V7.27a4.28 4.28 0 01-2.6-1.45z" />
                        </svg>
                        {{ $tr('lp.tiktok.badge', 'Offre Speciale TikTok') }}
                    </div>

                    <h1 class="lp-title" data-reveal style="--reveal-delay:.05s">
                        {{ $tr('lp.tiktok.title.l1', 'Maitrisez') }}
                        <span class="accent">{{ $tr('lp.tiktok.title.l2', "l'Allemand") }}</span><br>
                        {{ $tr('lp.tiktok.title.l3', 'en un temps record') }}
                    </h1>

                    <p class="lp-subtitle" data-reveal style="--reveal-delay:.15s">
                        {{ $tr('lp.tiktok.subtitle', "Methode certifiee, profs natifs, 7 villes au Maroc. Plus de 5000 etudiants nous font confiance. Inscrivez-vous gratuitement aujourd'hui.") }}
                    </p>
                    ...
                    <div class="lp-features">
                        <div class="lp-feature" data-reveal style="--reveal-delay:.20s">
                            ...
                            <div class="lp-feature-text">
                                <strong>{{ $tr('lp.tiktok.f1.title', 'De A0 a B2 en quelques mois') }}</strong>
                                <span>{{ $tr('lp.tiktok.f1.text', 'Progression rapide grace a notre methode intensive prouvee.') }}</span>
                            </div>
                        </div>
                        <div class="lp-feature" data-reveal style="--reveal-delay:.28s">
                            ...
                            <div class="lp-feature-text">
                                <strong>{{ $tr('lp.tiktok.f2.title', 'Certificats GLS, Goethe & OSD') }}</strong>
                                <span>{{ $tr('lp.tiktok.f2.text', 'Reconnus par toutes les universites allemandes.') }}</span>
                            </div>
                        </div>
                        <div class="lp-feature" data-reveal style="--reveal-delay:.36s">
                            ...
                            <div class="lp-feature-text">
                                <strong>{{ $tr('lp.tiktok.f3.title', 'Petits groupes, profs natifs') }}</strong>
                                <span>{{ $tr('lp.tiktok.f3.text', '15 a 25 etudiants max par classe pour un suivi personnalise.') }}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="lp-proof" data-reveal="fade" style="--reveal-delay:.45s">
                        ...
                        <div class="lp-proof-text">
                            <b>4.9/5</b> &middot;
                            {{ $tr('lp.tiktok.proof', '+5000 etudiants formes, 98% taux de reussite') }}
                        </div>
                    </div>
                </div>
                ...
                <div class="lp-card lp-card--hero" data-reveal="right" style="--reveal-delay:.10s">
                    <div class="lp-card-top">
                        <h2>{{ $tr('lp.tiktok.form.title', 'Reservez votre place gratuitement') }}</h2>
                        <p>{{ $tr('lp.tiktok.form.subtitle', 'On vous rappelle sous 24h.') }}</p>
                    </div>
                    ...
                    <div class="lp-form">
                        ...
                        <form id="lpForm" data-form-source="tiktok_ads"
                            ...
                            <button type="submit" class="lp-submit" id="lpSubmitBtn">
                                {{ $tr('lp.tiktok.cta', 'Reserver ma place') }}
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4"
            ...
            <section class="lp-video-section">
                <div class="lp-section-head" data-reveal>
                    <span class="lp-section-eyebrow">{{ $tr('lp.tiktok.video.eyebrow', 'Notre histoire') }}</span>
                    <h2 class="lp-section-title-big">{{ $tr('lp.tiktok.video.title', 'Plan A, Plan B... ou Plan C ?') }}</h2>
                    <p class="lp-section-subtitle">{{ $tr('lp.tiktok.video.subtitle', 'Le bon choix pour partir en Allemagne. Decouvrez en 56 secondes pourquoi GLS est le plan qui marche.') }}</p>
                </div>

                <div class="lp-video-card" data-reveal="scale" style="--reveal-delay:.05s">
                    <div class="lp-video-card-top">
                        <div>
                            <h2>{{ $tr('lp.tiktok.video.title', 'Plan A, Plan B... ou Plan C ?') }}</h2>
                            <p>{{ $tr('lp.tiktok.video.subtitle_short', "Le bon choix pour partir en Allemagne") }}</p>
                        </div>
                    ...
                    <div class="lp-video-foot">
                        ...
                        <div class="lp-video-foot-text">
                            <b>{{ $tr('lp.tiktok.video.foot.title', 'GLS, le plan qui marche vraiment') }}</b>
                            {{ $tr('lp.tiktok.video.foot.text', "Pas de detour, pas de hasard - le chemin direct vers vos etudes en Allemagne.") }}
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="lp-how">
                <div class="lp-section-head" data-reveal>
                    <span class="lp-section-eyebrow">{{ $tr('lp.tiktok.how.eyebrow', 'Simple & rapide') }}</span>
                    <h2 class="lp-section-title-big">{{ $tr('lp.tiktok.how.title', 'Comment ca marche ?') }}</h2>
                    <p class="lp-section-subtitle">
                        {{ $tr('lp.tiktok.how.subtitle', 'Trois etapes pour commencer votre apprentissage de l\'allemand.') }}
                    </p>
                </div>
                ...
                <div class="lp-steps">
                    <div class="lp-step" data-reveal style="--reveal-delay:.05s">
                        ...
                        <h3>{{ $tr('lp.tiktok.step1.title', 'Reservez votre place') }}</h3>
                        <p>{{ $tr('lp.tiktok.step1.text', 'Remplissez le formulaire d\'inscription. Choisissez votre ville, type de cours et horaire en moins d\'une minute.') }}
                        </p>
                    </div>
                    ...
                    <div class="lp-step" data-reveal style="--reveal-delay:.15s">
                        ...
                        <h3>{{ $tr('lp.tiktok.step2.title', 'Test de niveau gratuit') }}</h3>
                        <p>{{ $tr('lp.tiktok.step2.text', 'Notre equipe vous contacte sous 24h pour evaluer votre niveau et vous orienter vers le bon groupe.') }}
                        </p>
                    </div>
                    ...
                    <div class="lp-step" data-reveal style="--reveal-delay:.25s">
                        ...
                        <h3>{{ $tr('lp.tiktok.step3.title', 'Commencez vos cours') }}</h3>
                        <p>{{ $tr('lp.tiktok.step3.text', 'Rejoignez votre groupe en presentiel ou en ligne. Progressez avec une methode certifiee et des profs passionnes.') }}
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section class="lp-gallery">
                <div class="lp-section-head" data-reveal>
                    <span class="lp-section-eyebrow">{{ $tr('lp.tiktok.gallery.eyebrow', 'Temoignages videos') }}</span>
                    <h2 class="lp-section-title-big">{{ $tr('lp.tiktok.gallery.title', 'Ils ont reussi avec GLS') }}</h2>
                    <p class="lp-section-subtitle">
                        {{ $tr('lp.tiktok.gallery.subtitle', 'Decouvrez les parcours d\'etudiants qui ont realise leur reve d\'aller en Allemagne.') }}
                    </p>
                </div>
            ...
            <section class="lp-sites">
                <div class="lp-section-head" data-reveal>
                    <span class="lp-section-eyebrow">{{ $tr('lp.tiktok.sites.eyebrow', 'Nos centres') }}</span>
