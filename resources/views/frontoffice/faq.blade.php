...
================================ --}}
    <section class="faq-hero reveal delay-1">
        <div class="faq-hero-container reveal delay-2">

            <h1 class="faq-hero-title reveal fade-blur-title delay-1">
                {{ __('faq.hero.title') }}
            </h1>

            <p class="faq-hero-subtitle reveal delay-2">
                {!! __('faq.hero.subtitle') !!}
            </p>

            {{-- Search --}}
            <div class="faq-hero-search reveal delay-3">
                <form id="faq-search-form" aria-label="FAQ Search">
                    <input type="text" id="faq-search" name="faq-search" class="faq-search-field" maxlength="256"
                        placeholder="{{ __('faq.hero.search_placeholder') }}" autocomplete="off">
                </form>
            </div>
    ...
    <section class="section faq-section py-5 reveal delay-1">
        ...
        <div class="container text-center mb-5 reveal delay-2">
            ...
            <div class="faq-filters d-flex flex-wrap justify-content-center gap-3 mb-4 reveal delay-3">
                <button class="faq-filter-btn active reveal delay-1"
                    data-category="all">{{ __('faq.filters.all') }}</button>
                <button class="faq-filter-btn reveal delay-2"
                    data-category="courses">{{ __('faq.filters.courses') }}</button>
                <button class="faq-filter-btn reveal delay-3"
                    data-category="recognition">{{ __('faq.filters.recognition') }}</button>
                ...
                <button class="faq-filter-btn reveal delay-1"
                    data-category="pricing">{{ __('faq.filters.pricing') }}</button>
            </div>
    ...
    <section class="get-started-section section reveal delay-1">
        ...
        <div class="container is-2-col-grid reveal delay-2">
            ...
            <div class="get-started-image reveal delay-3">
                <img src="{{ asset('assets/images/about/ctagls.avif') }}" alt="{{ __('faq.get_started.alt') }}"
    ...
    <section class="contact-section section reveal delay-1">
        <div class="container is-2-col-grid reveal delay-2">
            ...
            <a href="https://maps.app.goo.gl/g4PjrPB7wHQAqrSZA" target="_blank" class="div-block-7 reveal delay-3">
                <iframe src="{{ __('faq.contact.map_iframe') }}" loading="lazy" allowfullscreen
                    referrerpolicy="no-referrer-when-downgrade" class="reveal delay-1"></iframe>
            </a>
