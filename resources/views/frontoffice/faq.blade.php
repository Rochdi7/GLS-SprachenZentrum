    ...
    <section class="hero-section section is-no-image is-faq">
        <div class="container is-hero text-center">
            ...
            <p class="text-light mt-3" style="max-width: 720px; margin: 0 auto; line-height: 1.6;">
                At GLS Sprachenzentrum Morocco, learning German means building a strong foundation for your academic and
                professional future.
            ...
            <div class="faq-form w-form mt-4">
                <form id="faq-search-form" class="faq-form-block" aria-label="FAQ Search">
                    <input type="text" id="faq-search" name="faq-search" class="faq-search-field w-input" maxlength="256"
                        placeholder="Search your question..." autocomplete="off">
                </form>
            </div>
        </div>
    </section>
    ...
    <section class="section faq-section py-5">
        ...
        <div class="container faq-accordion">
            ...
            <div class="faq-item" data-category="courses">
                ...
                <div class="faq-answer">
                    <p>
                        ...
                        You can start from beginner and progress to advanced proficiency, according to your visa or academic
                        goals.
                    </p>
                    <p>
                        Our professors are among the most qualified and experienced in Morocco, and our method ensures
                        quick, confident language acquisition.
                    </p>
                </div>
            </div>
            ...
            <div class="faq-item" data-category="recognition">
                ...
                <div class="faq-answer">
                    <p>
                        Yes. Our courses follow international standards and are aligned with embassy and institution
                        requirements such as
                        <strong>Goethe-Institut</strong>, <strong>telc</strong>, and <strong>ÖSD</strong>.
                    </p>
                    <p>
                        Our training certificates are accepted by official German authorities for visa, study, and work
                        applications.
                    </p>
                </div>
            </div>
            ...
            <div class="faq-item" data-category="exams">
                ...
                <div class="faq-answer">
                    ...
                    <ul style="text-align:left; list-style-type:'• '; padding-left:1.2rem;">
                        <li><strong>ÖSD (Österreichisches Sprachdiplom Deutsch)</strong> – recognized across Europe and
                            accepted for visa and study applications</li>
                        <li><strong>Goethe-Institut Exams</strong> – globally recognized certification for all proficiency
                            levels</li>
                        <li><strong>GLS Certified Exam</strong> – our upcoming in-house examination designed to meet embassy
                            and training center standards (coming soon)</li>
                    </ul>
                    <p>
                        All GLS courses are aligned with these certification systems, ensuring that you are fully prepared
            ...
            <div class="faq-item" data-category="online">
                ...
                <div class="faq-answer">
                    ...
                    <p>
                        In-person courses are available in all GLS centers — Rabat, Salé, Kénitra, Casablanca, Agadir, and
                        Marrakesh.
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function filterFAQs() {
                faqItems.forEach(item => {
                    ...
                    const matchesSearch = questionText.includes(searchQuery) || answerText.includes(
                        searchQuery);
