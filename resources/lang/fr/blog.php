...
return [
    ...
    // =============================
    'meta' => [
        'title' => 'Blog GLS – Conseils & Ressources',
        'description' => 'Conseils pratiques, guides et actualités du GLS Sprachenzentrum pour vous aider à apprendre l’allemand et préparer votre projet en Allemagne.',
    ],
    ...
    'hero' => [
        'badge' => 'Blog',
        'title' => 'Conseils & Ressources GLS',
        'subtitle' => 'Guides pratiques, astuces d’examens et actualités pour vous aider à apprendre l’allemand et préparer votre avenir en Allemagne en toute confiance.',
        'meta' => 'Cours d’Allemand · Examens ÖSD & Goethe · Études & Travail en Allemagne',
    ],
    ...
    'sidebar' => [
        ...
        'categories' => [
            ...
            'exams' => 'Examens : ÖSD & Goethe',
            'study' => 'Étudier en Allemagne',
            'ausbildung' => 'Ausbildung & Travail',
            'visa' => 'Visa & Conseils administratifs',
        ],

        'popular' => [
            'title' => 'Populaires',
            'p1' => 'Combien d’heures pour chaque niveau d’allemand ?',
            'p2' => 'A1 vs A2 vs B1 : Qu’est-ce qui change ?',
            'p3' => 'Étudier en Allemagne : Les 5 premières étapes avec GLS',
        ],
    ],
    ...
    'latest' => [
        ...
        'subtitle' => 'Découvrez nos nouveaux articles sur l’apprentissage de l’allemand, les examens et la vie en Allemagne.',
    ],
    ...
    // =============================
    'cta' => [
        'title' => 'Prêt à commencer votre cours d’allemand ?',
        'subtitle' => 'Transformez ce que vous lisez en progrès réel. Rejoignez nos cours d’allemand GLS à Rabat, Salé, Kénitra, Casablanca, Agadir ou en ligne.',
        'btn_courses' => 'Voir les cours',
        'btn_contact' => 'Réserver une consultation',
    ],
