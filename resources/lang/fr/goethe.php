...
return [
    'meta' => [
        'title' => 'Examen Goethe – GLS Sprachenzentrum Maroc',
    ],

    'hero' => [
        'subtitle' => 'Examen Goethe au Maroc',
        'title' => 'Certification Allemande Goethe chez GLS',
        'alt' => 'Examen Goethe GLS Maroc',
    ],
    ...
    'path' => [
        'title' => 'Votre parcours des cours GLS à l’examen Goethe',
        ...
        'card2' => [
            ...
            'text' => 'Après chaque niveau, une préparation ciblée au format Goethe est organisée pour garantir votre réussite.',
            'button' => 'Préparation Goethe',
        ],

        'card3' => [
            'title' => 'Programmation<br>des examens',
            'text' => 'Une fois prêt, GLS programme la date de votre examen officiel directement avec le centre Goethe.',
            'button' => 'Voir les dates',
        ],

        'card4' => [
            'title' => 'Examen officiel<br>Goethe',
            'text' => 'Vous passez votre examen Goethe et recevez un certificat reconnu internationalement.',
    ...
    'levels' => [
        ...
        'gls_to_osd' => 'Du test GLS → Certificat Goethe',
        'gls_to_osd_text1' => 'Une fois votre examen interne validé, nous vous guidons vers l’examen officiel Goethe.',
        'gls_to_osd_text2' => 'Le certificat Goethe final est reconnu pour les études, le travail, l’Ausbildung ou les demandes de visa.',
    ],

    'exams' => [
        'title' => 'Tous les examens sur place !',
        'subtitle' => 'Centre officiel d’examen Goethe & Examen GLS (bientôt)',

        'card1' => [
            'title' => 'Examen Goethe',
            'text' => 'Examen officiel allemand reconnu pour les études, le travail, l’Ausbildung et les visas.',
        ...
        'card3' => [
            ...
            'text' => 'Vous ne connaissez pas votre niveau ? Notre test vous guide vers la préparation Goethe adaptée.',
    ...
    // =========================================================
    'contact' => [
    'title' => 'Des Questions sur l’examen Goethe ?<br>Contactez-nous !',
