...
return [
    ...
    'meta_title' => 'تعلم الألمانية في المغرب | دورات ألمانية – GLS',
    'meta_description' => 'مركز تعليم اللغة الألمانية في المغرب: دورات مكثفة A1–B2، تحضير امتحان غوته وشهادات معتمدة. 6 فروع في المغرب.',
    ...
    // ========================
    'site_heading' => [
        'rabat'      => 'دورة ألمانية الرباط – GLS',
        'kenitra'    => 'مركز GLS القنيطرة',
        'marrakech'  => 'مدرسة ألمانية مراكش – GLS',
        'sale'       => 'تعلم الألمانية سلا – GLS',
        'agadir'     => 'دورة ألمانية أكادير – GLS',
        'casablanca' => 'مدرسة ألمانية الدار البيضاء – GLS',
    ],

    'intro' => [
        'logo_alt' => 'شعار GLS Sprachenzentrum',
        ...
        'intensive' => [
            ...
            'cards' => [
                ...
                'b1' => [
                    'letter' => 'B',
                    'number' => '1',
                    'title' => 'ألمانية B1<br>متوسط',
                    'text' => 'طوّر مهاراتك في اللغة الألمانية.',
                    'button' => 'تحضير غوته B1',
                    'route' => 'front.exams.goethe',
                ],
                'b2' => [
                    'letter' => 'B',
                    'number' => '2',
                    'title' => 'ألمانية B2<br>متقدم',
    ...
    'contact' => [
        ...
        'centers_list' => [
            'casablanca' => [
                ['address' => '14 Bd de Paris, 1er étage N°8, Casablanca 20000', 'maps_url' => 'https://maps.app.goo.gl/EdqBoa3KWEYjuzoq7'],
            ],
            'marrakech' => [
                ['address' => 'Avenue Yacoub El Mansour, Immeuble Espace Guéliz, 3ème étage Bureau 28, Marrakech', 'maps_url' => 'https://maps.app.goo.gl/krR8pGZue3DW3yyv6'],
            ],
            'rabat' => [
                ['address' => 'Avenue Fal Ould Oumeir, Immeuble 77, 1er étage numéro 1, Rabat 10000', 'maps_url' => 'https://maps.app.goo.gl/mUnSAVYEnGToS8i2A'],
                ['address' => '1er étage, 99 Av. Fal Ould Oumeir, Rabat 10000',                       'maps_url' => 'https://maps.app.goo.gl/dnXUTeupDvomfjg89'],
            ],
            'kenitra' => [
                ['address' => 'Avenue Mohammed V, Bureaux Rania, 7ème étage, Kénitra', 'maps_url' => 'https://maps.app.goo.gl/pEsso9L8ygWpdSor5'],
            ],
            'sale' => [
